    ...
    class csNegocio
    {
        ...
        public void vInsertarRegistro(ArrayList alDatosEntrada, string sCodigo)
        {
            ...
            if(alCampos != null)
            {
                ...
                if (alDatosEntrada.Count == alCampos.Count)
                {
                    ...
                    {
                        MessageBox.Show("Los datos no son aceptados.", "Producción", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                else
                {
                    MessageBox.Show("Los campos no coiciden.", "Producción", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        ...
        public ArrayList alConsultarRegistro(ArrayList alDatosEntrada)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Formatos de los valores estan incorrectos", "Producción", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
