/* Autor: Andrea Pérez
 * Fecha: 20/09/2014 
 * Comentario: Programación de función alConsultarRegistro
 * Fecha: 22/09/2014
 * Comentario: Programación de función vInsertarRegistro
 */
/* Autor: Jeniffer López
 * Fecha: 21/09/2014 
 * Comentario: Programación de función vEliminarRegistro
 * Fecha: 23/09/2014
 * Comentario: Programación de función vModificarRegistro
 */
using System;
...
namespace Navegador
{
    class csDatos
    {
        ...
        public ArrayList alConsultarRegistros(ArrayList alDatosEntrada)
        {
            ...
            alDatosSalida = ODBCconnector.csFunciones.alConsultarQuery(sQuery);
            return alDatosSalida;
        }

        public void vInsertarRegistro(ArrayList alCampos, ArrayList alDatos, bool bTablaMaster)
        {
            ...
            sQuery += ")";
            ODBCconnector.csFunciones.bEjecutarQuery(sQuery, "insertar", bTablaMaster, SNombreTabla);
        }

        public void vModificarRegistro(ArrayList alDatos, bool bTablaMaster)
        {
            ...
            ODBCconnector.csFunciones.bEjecutarQuery(sQuery, "modificar", bTablaMaster, SNombreTabla);
        }

        public void bEliminarRegistro(ArrayList alDatosEntrada, bool bTablaMaster)
        {
            string sQuery = "update " + sNombreTabla + " set ";
            ...
            ODBCconnector.csFunciones.bEjecutarQuery(sQuery, "eliminar", bTablaMaster, SNombreTabla);
        }
    }
}
