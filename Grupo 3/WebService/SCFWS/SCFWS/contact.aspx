<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="SCFWS.contact" %>
        	...
        	<div class="divPanel notop page-content">
            	<div class="row-fluid">
                	<div class="span8" id="divMain">
                		<br /> <br />
                    	<h1>Contáctenos</h1>
                   		<iframe width="100%" height="350" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3861.2059327076945!2d-90.51368112982244!3d14.587338332627692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9f7bd4a0d2a52c7e!2sedificio+europlaza%2C+zona+14!5e0!3m2!1sen!2s!4v1395790404733"></iframe>
						<br /><br /><br />
						<!--Start Contact form -->		                                                
						<form name="enq" method="post" action="email/" onsubmit=";">
  							<fieldset>
    							...
    							<div class="actions">
									<input type="submit" value="Enviar mensaje" name="submit" id="submitButton" class="btn btn-primary pull-right" title="Click aqui para enviar su mensaje!" tabindex="4" onclick=""/>
								</div>
							</fieldset>
						</form>  				 
						<!--End Contact form -->	 
