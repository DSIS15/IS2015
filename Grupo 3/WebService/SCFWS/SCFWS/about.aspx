<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="SCFWS.about" %>
                ...
                <div class="span12">
                    ...
                    <div class="navbar">
                        ...
                        <div class="nav-collapse collapse">
                            ...
                            <li class="active"><a href="about.aspx">Quienes Somos</a></li>
        	...
        	<div class="divPanel notop page-content">
	            <div class="row-fluid">
                	...
                	<div class="span8" id="divMain">
                		<br /><br />
	                	<h1>Quienes Somos</h1>
						<p style="text-align:left;">EBRI Center nace en el año 2014 como el resultado del emprendimiento de Anthony Molineros y sus asociados Marlon Aldana, Jeniffer López, Daniel Moreno, Andrea Pérez y Kevin Gutiérrez, todos graduados de Ingeniería en Sistemas de Información. La cual está ubicada en Boulevard Las Américas, zona 14 de la ciudad de Guatemala. Implementando nuevos servicios especializados e innovacionales en la recuperación de información, Backup Online, Backup Offline y encriptación de información para las organizaciones de hoy en día.</p>
<p style="text-align:left;">
Actualmente, ya cuenta con un elevado número de implantaciones con éxito en diferentes empresas y pertenecientes a diferentes sectores.</p>
<p style="text-align:left;">
Disponemos de una gran experiencia en el desarrollo de proyectos para la promoción, gestión y  de seguridad de información de diferentes tipos de productos y sectores. EBRI Center cuenta con un equipo de más de 10 personas entre Ingenieros, Consultores, Programadores, Diseñadores y Técnicos especializados en las diferentes áreas de trabajo de los diferentes proyectos.</p>
            		</div>
					<!--End Main Content Area here-->
					<!--Edit Sidebar Content here-->
            		<div class="span4 sidebar">
                		<div class="sidebox">
                			<img src="images/quienes somos.png" class="img-polaroid" style="margin:5px 0px 15px;" alt="Quienes Somos" />
                   		</div>                    
            		</div>
