<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consulting.aspx.cs" Inherits="SCFWS.consulting" %>
                ...
                <div class="span12">
                    ...
                    <div class="navbar">
                        ...
                        <div class="nav-collapse collapse">
                            ...
                            <li class="active"><a href="consulting.aspx">Consultoría de Software</a></li>
                            </ul>
                            </li>
                            <li class="dropdown">
        	...
        	<div class="divPanel notop page-content">
	            <div class="row-fluid">
            		...
            		<div class="span8" id="divMain">
                    	...
                    	<p style="text-align:left;">Nuestros profesionales ponen nuestra alta experiencia al servicio del cliente para asistirle con las mejores opciones a implantar. El fin es conseguir una perfecta alineación entre los objetivos de la organización y las capacidades de sus sistemas informáticos.</p>
                    	<p style="text-align:left;">El valor añadido que proporcionamos es la alta capacidad que da esa experiencia a nuestros consultores para alcanzar un elevado conocimiento de las necesidades de cada empresa, u organización en general, y de los procedimientos y objetivos que rigen su funcionamiento. Sólo así nos vemos capacitados para poder seleccionar la arquitectura y herramientas más adecuadas en cada caso, que sirvan a la organización para sacar el máximo provecho de una manera eficiente.</p>
                	</div>
					<!--End Main Content Area here-->
					<!--Edit Sidebar Content here-->
              		<div class="span4 sidebar">
                		<div class="sidebox">
                			<img src="images/consulting.jpg" class="img-polaroid" style="margin:5px 0px 15px;" alt="Consultoría de Software" />
                    	</div>                    
            		</div>
